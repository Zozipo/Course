...
namespace Compass.Services
{
    public class UserService
    {
        ...
        public async Task<ServiceResponse> RegisterUserAsync(RegisterUserVM model)
        {
            ...
            var result = await _userRepository.RegisterUserAsync(newUser, model.Password, model.Role);
            if (result.Succeeded)
            {
        ...
        public async Task<ServiceResponse> UpdateUserAsync(UpdateUserVM model)
        {
            var user = await _userRepository.GetUserByIdAsync(model.Id);

            var newUser = _mapper.Map<UpdateUserVM, AppUser>(model, user);
